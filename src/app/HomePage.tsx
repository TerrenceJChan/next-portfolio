...
import HomeSideNav from "@/components/Navs/HomeSideNav";
...
const HomePage = () => {
  ...
  return (
    <>
      {(screenSize === "mobile" || screenSize === "tablet") && <MobileNav />}
      <div className="overflow-x-hidden">
        {screenSize === "desktop" && <HomeSideNav />}
          ...
          <div className="relative grid max-h-screen grid-cols-1 items-center justify-center gap-4 sm:grid-cols-2 sm:gap-8">
            ...
            >
              <Image
                ...
                fill
                className="bottom-0 object-contain pt-28 opacity-80 sm:pt-8 sm:opacity-100"
              />
            </motion.div>
          </div>
          {/* End Hero */}
